...
interface NexusPrismaInputs {
  Query: {
    ...
    userTechnologies: {
      filtering: 'AND' | 'OR' | 'NOT' | 'id' | 'createdAt' | 'updatedAt' | 'components' | 'date_from' | 'date_till' | 'status' | 'hiring_status' | 'CreatedBy' | 'User' | 'Technology' | 'Technology_TechnologyToUserTechnology' | 'level'
