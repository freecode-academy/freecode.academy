...
interface NexusPrismaOutputs {
  ...
  CallRequest: {
    id: 'String'
    called_descriptions: 'String'
    caller_descriptions: 'String'
    status: 'String'
    startedAt: 'DateTime'
    endedAt: 'DateTime'
    Room: 'String'
