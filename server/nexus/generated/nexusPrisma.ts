...
interface NexusPrismaInputs {
  Query: {
    ...
    chatMessages: {
      filtering: 'AND' | 'OR' | 'NOT' | 'id' | 'createdAt' | 'updatedAt' | 'content' | 'contentText' | 'CreatedBy' | 'Room' | 'User' | 'ChatRoom' | 'ChatMessagesReaded' | 'Notices' | 'toUser' | 'ToUser'
      ordering: 'id' | 'createdAt' | 'updatedAt' | 'content' | 'contentText' | 'CreatedBy' | 'Room' | 'User' | 'ChatRoom' | 'ChatMessagesReaded' | 'Notices' | 'toUser' | 'ToUser'
    }
    chatMessageReadeds: {
    ...
    aiAgents: {
      filtering: 'AND' | 'OR' | 'NOT' | 'id' | 'createdAt' | 'updatedAt' | 'userId' | 'User' | 'prompt'
      ordering: 'id' | 'createdAt' | 'updatedAt' | 'userId' | 'User' | 'prompt'
    }
  },
  User: {
