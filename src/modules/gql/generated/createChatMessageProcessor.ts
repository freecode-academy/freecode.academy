...
export type CreateChatMessageProcessorMutation = { __typename?: 'Mutation', response: { __typename?: 'ChatMessageResponse', success: boolean, message: string, errors: Array<{ __typename?: 'Error', key: string, message: string }>, data?: Types.Maybe<(
