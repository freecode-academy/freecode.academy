...
export type CreateTaskTechnologyProcessorMutation = { __typename?: 'Mutation', response: { __typename?: 'TaskTechnologyResponse', success: boolean, message: string, errors: Array<{ __typename?: 'RequestError', key: string, message: string }>, data?: Types.Maybe<(
