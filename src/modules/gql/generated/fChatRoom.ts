...
export type FChatRoomFragment = (
  { __typename?: 'ChatRoom', CreatedBy: (
    ...
    & UserNoNestingFragment
      ...
      { __typename?: 'User' }
      & UserNoNestingFragment
    ) }>>, Messages?: Types.Maybe<Array<{ __typename?: 'ChatMessage', id: string, createdAt: globalThis.Date, updatedAt: globalThis.Date, content?: Types.Maybe<globalThis.Record<string, any> | globalThis.Array<any>>, CreatedBy?: Types.Maybe<(
      { __typename?: 'User' }
      & UserNoNestingFragment
    )> }>> }
