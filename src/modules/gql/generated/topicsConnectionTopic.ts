...
export type TopicsConnectionTopicFragment = { __typename?: 'Resource', id: string, updatedAt: globalThis.Date, name: string, uri: string, longtitle?: Types.Maybe<string>, CreatedBy: (
    { __typename?: 'User' }
