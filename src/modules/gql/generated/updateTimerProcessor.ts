...
export type UpdateTimerProcessorMutation = { __typename?: 'Mutation', response: { __typename?: 'TimerResponse', success: boolean, message: string, errors: Array<{ __typename?: 'RequestError', key: string, message: string }>, data?: Types.Maybe<(
      { __typename?: 'Timer' }
